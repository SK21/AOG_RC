...
namespace RateController
{
    public class clsSections
    {
        ...
        {
            Debug.Print("MasterOn: " + MasterOn.ToString());
            Debug.Print("AOGmasterOn: " + AOGmasterOn.ToString());
        ...
        private void AOGnew_RelaysChanged(object sender, PGN254.RelaysChangedArgs e)
        {
            ...
            {
                AOGmasterOff = true;    // simulates a momentary off 
                MasterOn = false;
            }
            else
            {
                AOGmasterOn = true;     // simulates a momentary on
                MasterOn = true;
            }
