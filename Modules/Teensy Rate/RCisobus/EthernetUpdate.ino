...
DMAMEM uint8_t ReceivedData[500];

FLASHMEM void ReceiveUpdate()
{
...
FLASHMEM void SendUpdateStatus(byte Status)
{
	// PGN32802
	//0		headerlo	34
	//1		headerHi	128
...
//******************************************************************************
FLASHMEM int process_hex_record(const uint8_t* packetBuffer, int packetSize)
{
