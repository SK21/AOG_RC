...
const float BrakePoint = 0.4;				// error amount where adjustment rate changes from fast to slow
...
const float MaxMotorIntegral = 0.01;		// for a motor  Ex: 0.05 = max 1 pwm/sec change at 50 ms sample time
