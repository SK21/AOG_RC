...
void ReadAnalog()
{
	...
	case 1:
		...
		// WAS, 0 - 4095
		AINs.AIN0 = (adc->adc0->analogRead(PINS.WAS));

		if (steerConfig.PressureSensor)
		{
			AINs.AIN1 = (adc->adc0->analogRead(PINS.PressureSensor));
		}

		if (steerConfig.CurrentSensor)
		{
			AINs.AIN2 = (adc->adc0->analogRead(PINS.CurrentSensor));
		}
		break;
