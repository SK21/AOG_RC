    ...
    public partial class frmNanoSettings : Form
    {
        ...
        private void bntOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ButtonClicked.Text == Configurator.Languages.Lang.lgClose)
                {
                    bool Edited = false;
                    for (int i = 0; i < 2; i++)
                    {
        ...
        private void ckUseEthernet_HelpRequested(object sender, HelpEventArgs hlpevent)
        {
            string Message = "Connect to module with ethernet or serial/usb.";

            mf.Tls.ShowHelp(Message, "Use Ethernet");
            hlpevent.Handled = true;
        }
        ...
        private void frmNanoSettings_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    tabControl1.TabPages[i].BackColor = Configurator.Properties.Settings.Default.DayColour;
                }
