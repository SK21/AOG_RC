...
namespace RateController
{
    public partial class frmMenu : Form
    {
        ...
        public frmMenu(bool LoadLst = true)
        {
            InitializeComponent();
        ...
        public void ChangeProduct(int NewID, bool NoFans = false)
        {
            ...
            cCurrentProduct = Core.Products.Item(NewID);
        ...
        private void btnPressure_Click(object sender, EventArgs e)
        {
            ...
            if (fs == null)
            {
                Form frm = new frmMenuPressure(this);
                frm.Owner = this;
                frm.Show();
            }
        }
        ...
        private void butCalibrate_Click(object sender, EventArgs e)
        {
            ...
            if (fs == null)
            {
                Form frm = new frmMenuCalibrate(this);
                frm.Owner = this;
                frm.Show();
            }
        }
        ...
        private void butConfig_Click(object sender, EventArgs e)
        {
            ...
            if (fs == null)
            {
                Form frm = new frmMenuConfig(this);
                frm.Owner = this;
                frm.Show();
            }
        }
        ...
        private void butControl_Click(object sender, EventArgs e)
        {
            if (CheckEdited())
            {
                ...
                if (fs == null)
                {
                    Form frm = new frmMenuControl(this);
                    frm.Owner = this;
                    frm.Show();
                }
            }
        ...
        private void butLanguage_Click(object sender, EventArgs e)
        {
            ...
            if (fs == null)
            {
                Form frm = new frmMenuLanguage(this);
                frm.Owner = this;
                frm.Show();
            }
        }
        ...
        private void butMonitor_Click(object sender, EventArgs e)
        {
            ...
            if (fs == null)
            {
                Form frm = new frmMenuMonitoring(this);
                frm.Owner = this;
                frm.Show();
            }
            else
        ...
        private void butNetwork_Click(object sender, EventArgs e)
        {
            ...
            if (fs == null)
            {
                Form frm = new frmMenuNetwork(this);
                frm.Owner = this;
                frm.Show();
            }
            else
        ...
        private void butProfiles_Click(object sender, EventArgs e)
        {
            ...
            if (fs == null)
            {
                Form frm = new frmMenuProfiles(this);
                frm.Owner = this;
                frm.Show();
            }
            else
        ...
        private void butRelayPins_Click(object sender, EventArgs e)
        {
            ...
            if (fs == null)
            {
                Form frm = new frmMenuRelayPins(this);
                frm.Owner = this;
                frm.Show();
            }
            else
        ...
        private void butRelays_Click(object sender, EventArgs e)
        {
            ...
            if (fs == null)
            {
                Form frm = new frmMenuRelays(this);
                frm.Owner = this;
                frm.Show();
            }
            else
        ...
        private void butSections_Click(object sender, EventArgs e)
        {
            ...
            if (fs == null)
            {
                Form frm = new frmMenuSections(this);
                frm.Owner = this;
                frm.Show();
            }
            else
        ...
        private void butSettings_Click(object sender, EventArgs e)
        {
            ...
            if (fs == null)
            {
                Form frm = new frmMenuSettings(this);
                frm.Owner = this;
                frm.Show();
            }
            else
        ...
        private void butSwitches_Click(object sender, EventArgs e)
        {
            ...
            if (fs == null)
            {
                Form frm = new frmMenuSwitches(this);
                frm.Owner = this;
                frm.Show();
            }
            else
