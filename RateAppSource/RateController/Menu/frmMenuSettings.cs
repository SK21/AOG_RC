    ...
    public partial class frmMenuSettings : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Core.Products.UniqueModSen(ModID, SenID, Prd.ID))
                {
                    Prd.ModuleID = ModID;
                    Prd.SensorID = SenID;
                    ...
                    bool EnabledChanged = (Prd.Enabled != ckEnabled.Checked);
        ...
        {
            if (Core.Products.Item(MainMenu.CurrentProduct.ID).RateSensorData.Connected())
            {
        ...
        private void UpdateForm()
        {
            ...
            if (!MainMenu.CurrentProduct.Enabled) Core.Products.SetEnabledDefault();
            ...
            else
            {
                ...
                ckScale.Checked = Props.ShowScaleGet(MainMenu.CurrentProduct.ID);
            }
