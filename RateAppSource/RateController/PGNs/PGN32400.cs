...
namespace RateController.PGNs
{
    public class PGN32400
    {
        ...
        { get { return cBinEmpty && ModuleSending(); } }
        ...
        public bool ParseByteData(byte[] Data)
        {
            ...
            {
                int tmp = Core.Tls.ParseModID(Data[2]);
                if (Prod.ModuleID == tmp)
                {
                    tmp = Core.Tls.ParseSenID(Data[2]);
                    if (Prod.SensorID == tmp)
                    {
                        ...
                        cBinEmpty = ((Data[11] & 0b00000010) == 0b00000010);
                        cHz = (Data[12] | Data[13] << 8) / 10.0;
