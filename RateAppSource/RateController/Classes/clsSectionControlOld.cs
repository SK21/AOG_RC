...
{
    public class clsSectionControlOld
    {
        ...
        public clsSectionControlOld(FormStart CallingForm)
        {
            mf = CallingForm;
        ...
        {
            CTL.AutoOn = mf.SwitchBox.SwitchIsOn(SwIDs.Auto);
            ...
            else if (mf.SwitchBox.SwitchIsOn(SwIDs.MasterOn) || CTL.MasterOn)
            {
                CTL.SBRlys0 = 0;
                CTL.SBRlys1 = 0;
                CTL.MasterOn = true;
