...
namespace RateController.RateMap
{
    ...
    public sealed class KmlLayerManager
    {
        ...
        public GMapOverlay LoadKml(string filePath)
        {
            try
            {
                ...
                using (var stream = File.OpenRead(filePath))
                {
                    ...
                    var placemarks = new List<SharpKml.Dom.Placemark>();
        ...
        private static void AddLineString(SharpKml.Dom.Placemark pm, LineString line, GMapOverlay overlay)
        {
        ...
        private static void AddPoint(SharpKml.Dom.Placemark pm, SharpKml.Dom.Point point, GMapOverlay overlay)
        {
